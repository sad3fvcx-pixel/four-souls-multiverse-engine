...
Постоянные модификаторы описываются не в `effects`, а в отдельном поле
`statics` карты. У них нет момента срабатывания: движок спрашивает значение,
и каждая карта в игре на него влияет.

См. `CARD_SCHEMA.md` §8.2.
